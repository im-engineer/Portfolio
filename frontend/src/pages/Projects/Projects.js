  ...
  let type = "dark";
    ...
    const useStyles = makeStyles((t) => ({
        search : {
            ...
            boxShadow: type === 'dark' ? 'inset 3px 3px 6px #ffffff10, inset -3px -3px 6px #00000060' : 'inset 3px 3px 6px #ffffffbd, inset -3px -3px 6px #00000030',
            "&::placeholder": {
                color: "#89abe3ff", 
            },
        ...
        home: {
            ...
            fontSize: '2rem',
            cursor: 'pointer',
            boxShadow:type ===  'dark' ? '3px 3px 6px #ffffff40, -3px -3px 6px #00000050' : '3px 3px 6px #ffffff40, -3px -3px 6px #00000050',
